...
!https://travis-ci.org/textpattern/txpmag-website.svg?branch=master!:https://travis-ci.org/textpattern/txpmag-website !https://cdn.gruntjs.com/builtwith.png(Built with Grunt)!:http://gruntjs.com/
