...
!https://travis-ci.org/textpattern/txpmag-website.svg?branch=master!:https://travis-ci.org/textpattern/txpmag-website !https://david-dm.org/philwareham/hive-framework/dev-status.svg(devDependency Status)!:https://david-dm.org/textpattern/txpmag-website#info=devDependencies !https://cdn.gruntjs.com/builtwith.png(Built with Grunt)!:http://gruntjs.com/
